...
// Theme Name   : Kredilink - Your link to seamless payment solution
// Version      : 1.0.
          ...
          if($("#contact-form").length) {
            $('#contact-form').on('submit', function (e) {
                ...
                if (!name || !email || !message) {
                    $form.find('.messages').html('<div class="alert alert-danger">Please fill in all required fields.</div>');
                    return false;
                }
                ...
                fetch(form.action, {
                    ...
                    if (response.ok) {
                        $form.find('.messages').html('<div class="alert alert-success">Message sent successfully! We will get back to you soon.</div>');
                        form.reset();
                    } else {
                        $form.find('.messages').html('<div class="alert alert-danger">Something went wrong. Please try again later.</div>');
                    }
                }).catch(function() {
                    $form.find('.messages').html('<div class="alert alert-danger">Something went wrong. Please try again later.</div>');
                }).finally(function() {
